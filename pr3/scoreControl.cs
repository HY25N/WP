    ...
    public partial class ScoreControl : UserControl
    {
        ...
        private void btnAddScore_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double score = double.Parse(txtAttendance.Text);
                double midTerm = double.Parse(txtMidTerm.Text);
                double finalTerm = double.Parse(txtFinalTerm.Text);

                // 성적 추가
                Score newScore = new Score(studentId, studentName, subject, score, midTerm, finalTerm);
                scores.Add(newScore);
        ...
        private void btnUpdateScore_Click(object sender, EventArgs e)
        {
            if (lstScores.SelectedItem != null)
            {
                ...
                selectedScore.ScoreValue = double.Parse(txtAttendance.Text);
